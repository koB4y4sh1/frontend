...
type type = "WORK"| "MEETING" | "REVIEW" | "INSPECTION"
...
const TodoItem = (props: TodoItemProps): JSX.Element => {
    ...
    switch (props.type) {
        case "WORK":
            ...
            statusClassName.icon = <MdTaskAlt className="w-6 h-6 text-white fill-current dark:text-black"></MdTaskAlt>
            break;
        case "MEETING":
            ...
            statusClassName.icon = <BsPersonVideo className="w-6 h-6 text-white fill-current dark:text-black"></BsPersonVideo>
            break;
        case "REVIEW":
            ...
            statusClassName.icon = <GoCodeReview className="w-6 h-6 text-white fill-current dark:text-black"></GoCodeReview>
            break;
        case "INSPECTION":
            ...
            statusClassName.icon = <MdPreview className="w-7 h-7 text-white fill-current dark:text-black"></MdPreview>
            break;
    }
        ...
        <div className="flex w-full border border-gray-300  overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800">
            ...
            <div className="px-4 py-2 w-60">
                <div className="mx-3">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-100">{props.content}</p>
                </div>
            </div>
            <div className="flex items-center w-15 border-l border-white">
                <div className="mx-3">
                    <span className="text-sm text-gray-600 dark:text-gray-100">{props.time}</span>
                </div>
            </div>
        </div>
    )
